...
def test_convert_csv_to_parquet(mocker):
    ...
    result_path, result_name = convert_csv_to_parquet(csv_file_path, encoding, sep)
...
def test_convert_csv_to_parquet_with_custom_path(mocker):
    ...
    result_path, result_name = convert_csv_to_parquet(csv_file_path, sep, encoding, parquet_file_path)
